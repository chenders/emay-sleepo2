...
func TestParseReadingValid(t *testing.T) {
	...
	if *r.Pulse != 62 {
		t.Errorf("pulse = %d, want 62", *r.Pulse)
	}
	if *r.SpO2 != 98 {
		t.Errorf("spo2 = %d, want 98", *r.SpO2)
	}
}
...
func TestParseReadingSentinelPR(t *testing.T) {
	...
	if r.Pulse != nil {
		t.Error("pulse should be nil for 0x00 sentinel")
	}
	if r.SpO2 == nil || *r.SpO2 != 98 {
		t.Error("spo2 should be 98")
	}
}
...
func TestParseReadingSentinelSpO2(t *testing.T) {
	...
	if r.SpO2 != nil {
		t.Error("spo2 should be nil for 0xFF sentinel")
	}
}
...
func TestParseReadingBothSentinels(t *testing.T) {
	...
	if r.Pulse != nil {
		t.Error("pulse should be nil")
	}
	if r.SpO2 != nil {
		t.Error("spo2 should be nil")
	}
}

func TestParseReadingPulseTooLow(t *testing.T) {
	if r := parseReading(frame(29, 98)); r != nil {
		t.Error("expected nil")
	}
}

func TestParseReadingPulseTooHigh(t *testing.T) {
	if r := parseReading(frame(221, 98)); r != nil {
		t.Error("expected nil")
	}
}
...
func TestParseReadingPulseBoundary(t *testing.T) {
	...
	if r == nil || *r.Pulse != 30 {
		t.Error("pulse 30 should be accepted")
	}
	r = parseReading(frame(220, 98))
	if r == nil || *r.Pulse != 220 {
		t.Error("pulse 220 should be accepted")
	}
}

func TestParseReadingSpO2TooHigh(t *testing.T) {
	if r := parseReading(frame(62, 101)); r != nil {
		t.Error("expected nil")
	}
}
...
func TestParseReadingSpO2Boundary(t *testing.T) {
	...
	if r == nil || r.SpO2 != nil {
		t.Error("spo2 0x00 should be sentinel")
	}
	r = parseReading(frame(62, 1))
	if r == nil || *r.SpO2 != 1 {
		t.Error("spo2 1 should be accepted")
	}
	r = parseReading(frame(62, 100))
	if r == nil || *r.SpO2 != 100 {
		t.Error("spo2 100 should be accepted")
	}
}
